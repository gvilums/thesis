...
void setup_inputs(struct dpu_set_t set,
                   ...
                   const input_t* input,
                   size_t elem_count
                   /* further arguments for global inputs: 
                   const global_0_t* global_0,
                   const global_1_t* global_1,
                   ...
                   */
                   ) {
...
int process(reduction_out_t* output, const input_t* input, size_t elem_count /* global_0_t global_0, global_1_t global_1, ... */) {
    ...
    setup_inputs(set, nr_dpus, input, elem_count /* global_0, global_1, ... */);
